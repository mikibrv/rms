...
public class UserFactoryTest {
    ...
    public void testDeserializationRoot() {
        ...
        UserIdentity userIdentity = UserFactory.fromSerializedString(email);
    ...
    public void testDeserializationContact() {
        ...
        UserIdentity userIdentity = UserFactory.fromSerializedString(contact + StringConstants.ENTITY_SEPARATOR + root);
        assertNotNull(userIdentity);
